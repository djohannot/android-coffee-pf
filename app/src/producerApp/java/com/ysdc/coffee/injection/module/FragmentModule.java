...
import com.ysdc.coffee.ui.orders.OrdersMvpPresenter;
import com.ysdc.coffee.ui.orders.OrdersMvpView;
import com.ysdc.coffee.ui.orders.OrdersPresenter;
import com.ysdc.coffee.ui.status.StatusMvpPresenter;
import com.ysdc.coffee.ui.status.StatusMvpView;
import com.ysdc.coffee.ui.status.StatusPresenter;
...
public class FragmentModule {
    ...
    @Provides
    @FragmentScope
    OrdersMvpPresenter<OrdersMvpView> provideOrdersPresenter(ErrorHandler errorHandler, ProductRepository productRepository, OrderRepository orderRepository) {
        return new OrdersPresenter<>(errorHandler, productRepository, orderRepository);
    }

    @Provides
    @FragmentScope
    StatusMvpPresenter<StatusMvpView> provideStatusPresenter(ErrorHandler errorHandler, ConfigurationRepository configurationRepository, MyPreferences preferences) {
        return new StatusPresenter<>(errorHandler, configurationRepository, preferences);
    }
}
